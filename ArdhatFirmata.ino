...
// Define State Machine used in main loop

SM button(Open); //button FSM
SM led(PulseStart); //led FSM
...
void loop()
{
  ...
  if (currentMillis - previousMillis > samplingInterval) {
    ...
    EXEC(button);  //check for Navigation Switch events
